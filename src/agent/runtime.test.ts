...
describe('createAgentRuntime', () => {
  ...
  test('opens and sends through the deferred qq capability using durable focus', async () => {
    const context = createAgentContext()
    ...
    assert.deepEqual(context.getSnapshot().qqConversationFocus, { type: 'private', userId: 2002 })
