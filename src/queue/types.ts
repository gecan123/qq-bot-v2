...
export interface JobQueue {
  enqueue<T extends string, D>(type: T, data: D, options?: JobEnqueueOptions): void
  enqueueAndWait<T extends string, D>(type: T, data: D, options?: JobEnqueueOptions): Promise<void>
